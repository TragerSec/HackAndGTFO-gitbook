...
* [Сканируем порты с помощью nmap](prokhozhdenie-hackthebox-lame.md#Сканируем-порты-с-помощью-nmap)
* [Ищем эксплоит в metasploit](prokhozhdenie-hackthebox-lame.md#Ищем-эксплоит-в-metasploit)
* [Запускаем эксплоит и получаем рута](prokhozhdenie-hackthebox-lame.md#Запускаем-эксплоит-и-получаем-рута)

## Сканируем порты с помощью nmap

Сканируем порты с помощью дефолтного скрипта nmap:
